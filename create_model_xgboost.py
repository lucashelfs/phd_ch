...
def main():
    """Load data, train XGBoost model with MLflow tracking, and export artifacts."""
    ...
    # Start MLflow run
    with mlflow.start_run(run_name="XGBoost_Real_Estate_Prediction") as run:
        ...
        model_info = mlflow.sklearn.log_model(
            ...
            registered_model_name="real_estate_xgboost_model",
        )
        ...
        evaluation_report = {
            "model_type": "XGBRegressor with RobustScaler",
        ...
        print(f"Registered Model: real_estate_xgboost_model")
