...
def main():
    """Load data, train model with MLflow tracking, and export artifacts."""
    ...
    # Start MLflow run
    with mlflow.start_run(run_name="KNN_Real_Estate_Prediction") as run:
        ...
        mlflow.log_params(
            {
                **{f"knn_{k}": v for k, v in model_params.items()},
        ...
        model = pipeline.make_pipeline(
            ...
            neighbors.KNeighborsRegressor(**model_params),
        )
        ...
        model_info = mlflow.sklearn.log_model(
            ...
            registered_model_name="real_estate_knn_model",
        )
        ...
        print(f"Registered Model: real_estate_knn_model")
