...
class ModelLoadError(APIException):
    ...
    def __init__(self, message: str = "Failed to load prediction model"):
        super().__init__(
            message=message, status_code=503, error_code="MODEL_LOAD_ERROR"
        )
...
class DemographicDataError(APIException):
    ...
    def __init__(
        self,
        message: str = "Demographic data processing failed",
...
class ConfigurationError(APIException):
    ...
    def __init__(self, message: str = "Configuration error"):
        super().__init__(
            message=message, status_code=500, error_code="CONFIGURATION_ERROR"
        )
